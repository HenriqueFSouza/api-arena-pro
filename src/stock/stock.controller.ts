...
export class StockController {
  ...
  updateByInventory(
    ...
    @Body() updateByInventoryDto: UpdateByInventoryDto
  ) {
  ...
  @Put(":id/unit-price")
  @ApiOperation({ summary: "Update the unit price of a stock item" })
  ...
  updateUnitPrice(
    ...
    return this.stockService.updateUnitPrice(id, updateUnitPriceDto, user.id);
  }
